                    ...
                    <ul class="cart_items_list ul_li_block mb_30 clearfix">
                        <li>
                            <div class="item_image">
                                <img src="{{asset('/front/images/cart/cart_img_1.jpg')}}" alt="image_not_found">
                            </div>
                        ...
                        <li>
                            <div class="item_image">
                                <img src="{{asset('/front/images/cart/cart_img_2.jpg')}}" alt="image_not_found">
                            </div>
                            <div class="item_content">
                                <h4 class="item_title">Yellow Blouse</h4>
                                <span class="item_price">$30.00</span>
                        ...
                        <li>
                            <div class="item_image">
                                <img src="{{asset('/front/images/cart/cart_img_3.jpg')}}" alt="image_not_found">
                            </div>
                            <div class="item_content">
                                <h4 class="item_title">Yellow Blouse</h4>
                                <span class="item_price">$30.00</span>
                                ...
                                <div class="top_category_carousel2" data-slick='{"dots": false}'>
                                    ...
                                    <div class="slider_item">
                                        <div class="category_boxed">
                                            <a href="#!">
                                                <span class="item_image">
                                                    <img src="{{asset('/front/images/categories/category_2.png')}}" alt="image_not_found">
                                                </span>
                                    ...
                                    <div class="slider_item">
                                        <div class="category_boxed">
                                            <a href="#!">
                                                <span class="item_image">
                                                    <img src="{{asset('/front/images/categories/category_3.png')}}" alt="image_not_found">
                                                </span>
                                    ...
                                    <div class="slider_item">
                                        <div class="category_boxed">
                                            <a href="#!">
                                                <span class="item_image">
                                                    <img src="{{asset('/front/images/categories/category_4.png')}}" alt="image_not_found">
                                                </span>
                                    ...
                                    <div class="slider_item">
                                        <div class="category_boxed">
                                            <a href="#!">
                                                <span class="item_image">
                                                    <img src="{{asset('/front/images/categories/category_5.png')}}" alt="image_not_found">
                                                </span>
                                    ...
                                    <div class="product-pic">
                                        ...
                                        <div class="actions">
                                            <ul>
                                                ...
                                                <li>
                                                    <a class="quickview_btn" data-bs-toggle="modal" href="#new{{$new->id}}" role="button"><svg width="48px" height="48px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#2329D6" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#2329D6"> <title>Visible (eye)</title> <path d="M22 12C22 12 19 18 12 18C5 18 2 12 2 12C2 12 5 6 12 6C19 6 22 12 22 12Z"/> <circle cx="12" cy="12" r="3"/> </svg></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="details">
                                        ...
                                        <span class="price">
                                            <ins>
                                                <span class="woocommerce-Price-amount amount">
                                                    <bdi>
                                                        <span class="woocommerce-Price-currencySymbol">৳</span>{{$new->after_discount}}
                                                    </bdi>
                                                </span>
                                            </ins>
                                        </span>
                    ...
                    <div class="viewed_products_wrap arrows_topright">
                        <div class="viewed_products_carousel row" data-slick='{"dots": false}'>
                            ...
                            <div class="slider_item col">
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{asset('/front/images/viewed_products/viewed_product_img_5.png')}}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                ...
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{asset('/front/images/viewed_products/viewed_product_img_6.png')}}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
